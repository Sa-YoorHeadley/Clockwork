...
export default function SearchBar({ setFilterOptions }) {
    ...
    return (
      <div className= "filter function">
        ...
        <div className='filter-text'>
            <input type="text" placeholder='Filter current results' className='filter-text-input' onChange={changeFilterKey} />
          ...
          <select defaultValue={'ID'} onChange={changeFilterBy} className='filter-select'>
