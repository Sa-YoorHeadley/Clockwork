    ...
    return (
      <div className= "searchbar">
        <div className='searchbar-text'>
          <input type="text" className='searchbar-text-input' onChange={(event)=>{setSearchKey(event.target.value)}} />
          <svg width="25" height="26" viewBox="0 0 25 26" xmlns="http://www.w3.org/2000/svg" className='searchbar-text-icon'>
        ...
        <select onChange={handleChange} className='searchbar-select'>
